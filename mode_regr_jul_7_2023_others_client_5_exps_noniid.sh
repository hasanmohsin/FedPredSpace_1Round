...
data=$1
save_dir="./results_REGR_OTHERS_tuned_distill/"
#SET HYPERPARAMS
if [ "$data" == "airquality" ]
then
	lr_mcmc=1e-1
...
do
	...
	#python run_exp.py --mode fed_sgd --dataset $data --epoch_per_client $epochs_mult_round --lr $lr_sgd --num_round 5 --optim_type "sgdm" --save_dir $save_dir --seed $seed --non_iid 1.0

	#printf "\nRunning Fed SGDM Experiment 1 round: \n"
	#python run_exp.py --mode fed_sgd --dataset $data --epoch_per_client $epochs --lr $lr_sgd --num_round 1 --optim_type "sgdm" --save_dir $save_dir --seed $seed --non_iid 1.0
