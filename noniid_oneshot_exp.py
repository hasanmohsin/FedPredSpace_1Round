...
def majority_vote_class_pred(x, method, num_classes, batch_size):
    ...
    for c in range(method.num_clients):
        ...
        #print(pred_class)
        pred_classes[:, c] = pred_class #.cpu().numpy()
...
for non_iid in [0.0]: #, 0.3, 0.6,0.9]:
    ...
    for dataset in ["mnist", "f_mnist", "emnist", "cifar10", "cifar100"]:
        if dataset == "emnist" and non_iid==0.9:
            seeds = ["11", "12", "13", "14","15","16","17","19","20", "21"]
        elif dataset == "f_mnist" and non_iid == 0.9:
            seeds = ["11", "12", "13", "14","15","16","17","18","20", "21"]
        ...
        for seed in seeds:
            ...
            #load models for sgd corresponding to this dataset 
